...
export default function Hero() {
  return (
    <div className="md:h-screen pt-24">
      ...
      >
        <div className="bg-gray-800 w-full md:min-h-[500px] rounded-3xl relative items-center justify-center flex max-px-lg px-20 max-lg:px-8 max-md:flex-col overflow-hidden shadow-lg max-md:py-8">
          <div className="absolute bg-gray-900 right-0 top-0 w-[55%] h-full -skew-x-[30deg] translate-x-[200px]"></div>
